...
export class LogTableDataSource extends DataSource<LogTableItem> {
   ...
   */
  private getPagedData(data: LogTableItem[]): LogTableItem[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: LogTableItem[]): LogTableItem[] {
    ...
    return data.sort((a, b) => {
      ...
      switch (this.sort?.active) {
        case 'name': return compare(a.customer_id, b.customer_id, isAsc);
